...
import executionEngine.RunTestNG1;
...
public class Keyword {
    ...
    public static void clickElement(String object, String data){
        ...
        try {
            ...
            DRIVER.findElement(By.xpath(RunTestNG1.OR.getProperty(object))).click();
    ...
    public static void clickElementByLinkText(String object, String data){
        ...
        try {
            ...
            DRIVER.findElement(By.linkText(RunTestNG1.OR.getProperty(object))).click();
    ...
    public static void inputValue(String object, String data){
        ...
        try{
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(RunTestNG1.OR.getProperty(object)))).clear();
            DRIVER.findElement(By.xpath(RunTestNG1.OR.getProperty(object))).sendKeys(data);
    ...
    public static void submit(String object, String data){
        ...
        try{
            ...
            WebDriverWait wait = new WebDriverWait(DRIVER, 15);
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(RunTestNG1.OR.getProperty(object)))).submit();
    ...
    public static void  moveToElement(String object, String data){
        ...
        try{
            ...
            WebElement Element = DRIVER.findElement(By.xpath(RunTestNG1.OR.getProperty(object)));
    ...
    public static void  waitForElementPresent(String object, String data){
        ...
        try{
            ...
            WebDriverWait wait = new WebDriverWait(DRIVER, 15);
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(RunTestNG1.OR.getProperty(object))));
    ...
    public static void verifyElementIsExisted(String object, String data){
        ...
        try{
            ...
            WebDriverWait wait = new WebDriverWait(DRIVER, 15);
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(RunTestNG1.OR.getProperty(object))));
    ...
    public static void verifyText(String object, String data){
        ...
        try{
            ...
            String actualText = DRIVER.findElement(By.xpath(RunTestNG1.OR.getProperty(object))).getText();
    ...
    public static void selectByVisibleText(String object, String data){
        ...
        try{
            ...
            Select selectAction =  new Select(DRIVER.findElement(By.xpath(RunTestNG1.OR.getProperty(object))));
    ...
    public static void  verifyTextInTable(String object, String data){
        ...
        try{
            ...
            List<WebElement> listCell = DRIVER.findElements(By.xpath(RunTestNG1.OR.getProperty(object)));
    ...
    public static void verifyCheckboxIsChecked(String object, String data){
        ...
        try{
            ...
            WebElement checkbox = DRIVER.findElement(By.xpath(RunTestNG1.OR.getProperty(object)));
    ...
    public static void verifyRadioIsChecked(String object, String data){
        ...
        try{
            ...
            WebElement radio = DRIVER.findElement(By.xpath(RunTestNG1.OR.getProperty(object)));
    ...
    public static void checkCheckBox(String object, String data){
        ...
        try{
            ...
            WebElement objCheckbox = DRIVER.findElement(By.xpath(RunTestNG1.OR.getProperty(object)));
    ...
    public static void  clickTreeViewItem (String object, String data){
        ...
        try{
            ...
            WebElement treeView = DRIVER.findElement(By.xpath(RunTestNG1.OR.getProperty(object)));
